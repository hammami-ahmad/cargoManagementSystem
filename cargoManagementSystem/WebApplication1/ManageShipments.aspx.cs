...
namespace WebApplication1
{
    ...
    public partial class WebForm6 : System.Web.UI.Page
    {
        ...
        protected void Delete_Click(object sender, EventArgs e)
        {
            ...
            {
                con1.Open();
                SqlCommand cmd2 = new SqlCommand("DELETE FROM Shipment where Id='" + selectedID + "'", con1);
        ...
        protected void AddNew_Click(object sender, EventArgs e)
        {
            ...
            {
                con1.Open();
                SqlCommand cmd3 = new SqlCommand("insert into Shipment (Price , TypeOfShipment, PackageWeight , PackageDx , PackageDy , PackageDz , SenderFirstName  , SenderLastName , SenderCity , RecieverFirstName , RecieverLastName , RecieverCity ,CurrentStatus ) " +
                    "values ('" + shipment_price + "','" + ShipmentType.SelectedValue + "' , '" + float.Parse(weight.Text.Trim()) + "' , '" + float.Parse(Xd.Text.Trim()) + "' , '" + float.Parse(Yd.Text.Trim()) + "' , '" + float.Parse(Zd.Text.Trim()) + "' , '" + SFname.Text.Trim() + "' , '" + SLname.Text.Trim() + "' , '" + SCity.SelectedValue + "' , '" + RFname.Text.Trim() + "' , '" + RLname.Text.Trim() + "' , '" + RCity.SelectedValue + "' , 'On the way') SELECT SCOPE_IDENTITY() ", con1);
        ...
        protected void datagrid_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                con1.Open();
                SqlCommand cmd3 = new SqlCommand("select * from Shipment where Id = '" + id + "'", con1);
